...
function renderInfoOnSeller() {
    ...
    localStorage.setItem("sellerAddress", data.sellerAddress);
    localStorage.setItem("sellerIdNo", data.sellerIdNo);
    localStorage.setItem("sellerTaxNo", data.sellerTaxNo);
    localStorage.setItem("sellerDirector", data.sellerDirector);
...
function renderInfoOnBuyer() {
    ...
    localStorage.setItem("buyerName", data.buyerName);
    localStorage.setItem("buyerAddress", data.buyerAddress);
    localStorage.setItem("buyerIdNo", data.buyerIdNo);
...
function renderInfoOnBuyer2() {
    ...
    localStorage.setItem("buyer2Name", data.buyer2Name);
    localStorage.setItem("buyer2Address", data.buyer2Address);
    localStorage.setItem("buyer2IdNo", data.buyer2IdNo);
...
function renderInfoOnLot() {
    ...
    localStorage.setItem("lotNo", data.lotNo);
    localStorage.setItem("cadastreName", data.cadastreName);
...
function renderInfoOnApartment() {
    ...
    localStorage.setItem("apartmentNo", data.apartmentNo);
    localStorage.setItem("apartmentSurface", data.apartmentSurface);
    localStorage.setItem("apartmentFloorNo", data.apartmentFloorNo);
...
function renderInfoOnParking() {
    ...
    localStorage.setItem("parkingNo", data.parkingNo);
    localStorage.setItem("parkingSurface", data.parkingSurface);
    localStorage.setItem("parkingLevelNo", data.parkingLevelNo);
...
function renderInfoOnDeposit() {
    ...
    localStorage.setItem("depositAmount", data.depositAmount);

    function renderAllInfoOnDeposit() {
        var infoOnDeposit = document.querySelector("#infoOnDeposit");
        infoOnDeposit.innerHTML = `<span>The Parties agree that the Buyer is paying to the Seller the amount of ${depositAmount} EUR as the Deposit (Reservation fee for the Real Property), that represents security аnd evidence of the serious will and firm intention for the conclusion of the agreement and purchase of the Real Property under the terms and conditions set out in this Agreement (hereiпafter the: „Deposit“).
                        </span>`;
    }
    renderAllInfoOnDeposit();
}
